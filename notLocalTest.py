...
food_list = ['apple_pie', 'baby_back_ribs', 'baklava', 'beef_carpaccio', 'beef_tartare', 'beet_salad', 'beignets',
...
images = []
images.append('predict_images/apple_pie.jpg')
images.append('predict_images/beef_tartare.jpg')
images.append('predict_images/beef_tartare2.jpg')
images.append('predict_images/bibimbap.jpg')
images.append('predict_images/escargot.jpg')
images.append('predict_images/gnocchi.jpg')
